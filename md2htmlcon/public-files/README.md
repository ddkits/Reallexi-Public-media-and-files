...
Store-ready media generated by `npm run package`:

- Chrome: `assets/store-assets/chrome/screenshots/converter-1280x800.png`
- Chrome: `assets/store-assets/chrome/promotional/small-promo-tile-440x280.png`
- Chrome: `assets/store-assets/chrome/promotional/marquee-promo-tile-1400x560.png`
- Edge: `assets/store-assets/edge/screenshots/converter-1280x800.png`
- Edge: `assets/store-assets/edge/promotional/small-promo-tile-440x280.png`
- Edge: `assets/store-assets/edge/promotional/marquee-promo-tile-1400x560.png`
- VS Code: `assets/store-assets/vscode/icons/marketplace-icon-128.png`
- VS Code: `assets/store-assets/vscode/screenshots/vscode-webview-1280x800.png`
- VS Code: `assets/store-assets/vscode/promotional/marketplace-banner-1280x400.png`
...
`npm run package` also regenerates icons, README screenshots, store screenshots, promotional
tiles, public media files, `.vsix`, zipped browser packages, and unpacked extension folders.
The command fails if required store media is missing or has the wrong dimensions.
...
MD2HTML Converter icons, screenshots, store promotional images, GIFs, store metadata, and policy files into
`media/md2htmlcon/`.
